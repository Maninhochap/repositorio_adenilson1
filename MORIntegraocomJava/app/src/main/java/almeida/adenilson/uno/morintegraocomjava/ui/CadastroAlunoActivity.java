package almeida.adenilson.uno.morintegraocomjava.ui;
...
import almeida.adenilson.uno.morintegraocomjava.R;
...
public class CadastroAlunoActivity extends AppCompatActivity {
    ...
    private Aluno createAlunoRecord(){
        ...
        tblAluno.setGitgub_usuario(edtUsuarioGitHub.getText().toString());
